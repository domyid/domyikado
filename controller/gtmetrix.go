...
func RefreshGTMetrixHarianReport(respw http.ResponseWriter, req *http.Request) {
	...
	go func() {
		defer wg.Done()
		if err := report.RekapGTMetrixPagiHari(config.Mongoconn); err != nil {
...
// RefreshGTMetrixMingguanReport menjalankan laporan GTMetrix mingguan secara otomatis
...
// 	if sendMessage && !strings.Contains(msg, "Tidak ada data GTMetrix") {
// 		// Kirim laporan ke grup WhatsApp
// 		_, err := report.SendGTMetrixReportToGroup(config.Mongoconn, groupID, "yesterday", config.WAAPIToken, config.WAAPIMessage)
// 		if err != nil {
// 			resp.Status = "Error"
// 			resp.Location = "Laporan GTMetrix Kemarin"
// 			resp.Response = "Gagal mengirim laporan: " + err.Error()
...
// 		resp.Status = "Success"
// 		resp.Location = "Laporan GTMetrix Kemarin"
// 		resp.Response = "Laporan GTMetrix kemarin untuk grup " + groupID + " berhasil dikirim"
// 	} else {
// 		// Kembalikan laporan sebagai respons
// 		resp.Status = "Success"
// 		resp.Location = "Laporan GTMetrix Kemarin"
...
// // GetGTMetrixReportTotal mengirimkan laporan GTMetrix total
